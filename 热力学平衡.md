...
$$\begin{align}
 ...
 & \frac{\partial^{2} S}{\partial \eta_{i}\partial\eta_{j}}\delta \eta_{i}\delta \eta_{j}>0,\forall \delta \eta_{i},\delta \eta_{j}\implies \text{the matrix } \frac{\partial^{2}S}{\delta \eta_{i}\delta \eta_{j}}\text{ is positive definite}
\end{align}$$
## Ex:
...
\end{align}$$
这是因为$\frac{\partial S_{j}}{\partial U_{j}}$是
## Ex:
