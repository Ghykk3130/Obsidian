...
- Infinite potential $\left[ -\frac{L}{2},  \frac{L}{2} \right]$ solution: $\text{even partity: } \sqrt{ \frac{2}{L} }\cos\left( \frac{n\pi}{L}x \right)\text{ odd parity: }(\cos \leftrightarrow \sin),\ E_{n}= \frac{\hbar^{2}k^{2}}{2m}= \frac{\hbar^{2}}{2m}\left( \frac{n\pi}{L} \right)^{2}$
- Lindbladian: $L  = - \frac{1}{2}\sum_{m}C_{m}^{\dagger}C_{m}\rho + \text{h.c.}+\sum_{m}C_{m}\rho C_{m}^{\dagger} \text{, where }C_{m}=\sqrt{ \Gamma_{m} }\ket{g_{m}} \bra{e_{m}},\ \Gamma_{m}\in \mathbb{R}_{\geq 0}$ or replace with $(C_{m}\leftrightarrow D_{m}),\ D_{m}=\sqrt{ \gamma_{m} }\ket{\psi_{m}}\bra{\psi_{m}}$. 2-level system general form: $L= \begin{pmatrix} \Gamma \rho_{e e}& - \frac{1}{2}(\Gamma +\gamma_{g}+\gamma_{e}) \rho_{ge}  \\ - \frac{1}{2}(\Gamma+\gamma_{g}+\gamma_{e})\rho_{eg} & - \Gamma\rho_{e e}\end{pmatrix}$. Order: $\ket{g}, \ket{e}$.
