...
\end{align}$$
**Claim:**
$$2(\vec{r}\times(e_{i}  \dot{r_{i}}))+ (\vec{r}\times(\vec{\omega}\times \vec{r}))\cdot \vec{\omega}= L^{2}$$
**Proof of claim:**
$$\vec{L}=\mu \vec{r}\times  \dot{\vec{r}}$$
$$\begin{align}
\vec{r}\times  \dot{\vec{r}} & =\vec{r}\times(\vec{\omega} \times \vec{r}+e_{i}  \dot{r_{i}}) \\
 & = \vec{r}\times(e_{i}  \dot{r_{i}})
\end{align}$$
那么：
$$\begin{align}
|\vec{r}\times  \dot{\vec{r}} |^{2} & =(\vec{r}\times(e_{i}  \dot{r_{i}}))\cdot(\vec{r}\times(e_{j}  \dot{r_{j}})) \\
 & = 
\end{align}$$