将刚体的转动当做一个主动变换。即刚体系的基矢在随时间变动，而刚体系中矢量在刚体系中的coordinates不变。于是在不动的lab frame中，我们观察到刚体系中矢量的分量的变动。刚体系中的矢量的coordinates与lab frame中矢量的coordinates由$SO(3)$联系。我们仍然需要认为，矢量实体是不变的。
